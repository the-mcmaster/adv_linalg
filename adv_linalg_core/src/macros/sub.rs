...
macro_rules! matrix_unsliced_immut_sub {
    ($rhs_type:ty) => {
        type Output = Matrix<T>;

        fn sub(self, rhs: $rhs_type) -> Self::Output {
            if self.rows != rhs.rows || self.cols != rhs.cols {
                panic!("Matrices with different sizes cannot be subtracted together.")
            }
...
pub(crate) use matrix_unsliced_immut_sub;

macro_rules! matrix_right_sliced_immut_sub {
    ($rhs_type:ty) => {
        type Output = Matrix<T>;
...
pub(crate) use matrix_right_sliced_immut_sub;

macro_rules! matrix_left_sliced_immut_sub {
    ($rhs_type:ty) => {
        type Output = Matrix<T>;
...
pub(crate) use matrix_left_sliced_immut_sub;

macro_rules! matrix_both_sliced_immut_sub {
    ($rhs_type:ty) => {
        type Output = Matrix<T>;
...
pub(crate) use matrix_both_sliced_immut_sub;

macro_rules! matrix_sliced_mut_sub {
    ($rhs_type:ty) => {
        type Output = Self;
...
pub(crate) use matrix_sliced_mut_sub;

macro_rules! matrix_unsliced_mut_sub {
    ($rhs_type:ty) => {
        type Output = Self;
...
pub(crate) use matrix_unsliced_mut_sub;
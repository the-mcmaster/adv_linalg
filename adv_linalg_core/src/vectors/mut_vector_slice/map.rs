...
impl<'l, 'r, T> Map<MutVectorSlice<'r, T>> for MutVectorSlice<'l, T> {
...
impl<'l, T> Map<MutVector<T>> for MutVectorSlice<'l, T> {
    type Output = Vector<T>;
...
impl<'l, 'r, T> Map<VectorSlice<'r, T>> for MutVectorSlice<'l, T> {
    type Output = Vector<T>;
...
impl<'l, T> Map<Vector<T>> for MutVectorSlice<'l, T> {
    type Output = Vector<T>;

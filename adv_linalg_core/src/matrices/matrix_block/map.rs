...
impl<'l, T> Map<Matrix<T>> for MatrixBlock<'l, T> {
...
impl<'l, T> Map<MutMatrix<T>> for MatrixBlock<'l, T> {
    type Output = Matrix<T>;
...
impl<'l, 'r, T> Map<MatrixBlock<'r, T>> for MatrixBlock<'l, T> {
    type Output = Matrix<T>;
...
impl<'l, 'r, T> Map<MutMatrixBlock<'r, T>> for MatrixBlock<'l, T> {
    type Output = Matrix<T>;

...
impl<T> From<Vec<Vec<T>>> for MutMatrix<T> {
...
impl<T> From<MatrixBlock<'_, T>> for MutMatrix<T>
where
    T: Clone
{
...
impl<T> From<MutMatrixBlock<'_, T>> for MutMatrix<T>
where
    T: Clone
{
...
impl<T> From<Matrix<T>> for MutMatrix<T> {
